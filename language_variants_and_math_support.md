...
* Paid Microsoft Word since some version supports language variants (MS Word 2007 version does **not** support it). Free [Microsoft 365](https://www.office.com) online supports it too (I wasn't able to change/add language there but already set language is rendered correctly) but it doesn't support math formulas editing (but they are rendered nicely).
